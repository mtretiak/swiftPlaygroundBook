/*:
 - callout(Also me): Clearly I love **technology** and **UI/UX design**. I also love the outdoors, sports, music and a good cup of ☕️! And I never forget to have a beer along the way!
 */

/*:
 - callout(Finger Foods): I'd bring my fun loving attitude, extreme work ethic, and hunger for knowledge to the team at Finger Foods to help bring even more creative solution for the customers!
 */
...
let backgroundImages: [UIImage] = [/*#-editable-code Select pictures*/#imageLiteral(resourceName: "IMG_3168.jpg"), #imageLiteral(resourceName: "IMG_4207.jpg"), #imageLiteral(resourceName: "IMG_4826.jpg"),#imageLiteral(resourceName: "IMG_4836.jpg"), #imageLiteral(resourceName: "IMG_4855.jpg"),#imageLiteral(resourceName: "IMG_3148.jpg")/*#-end-editable-code*/]
...
let tennisImage = /*#-editable-code Choose a picture*/#imageLiteral(resourceName: "TeamLogo.png")/*#-end-editable-code*/
