/*:
 - callout(Let's Take a Look at My Projects): Here's a first look at some baby steps I've made using Android and **iOS technologies**
 */

/*:
 - callout(University of Calgary): While at the U of C I have been lucky to work with many team members and come up with some cool project ideas.**
 */
//#-hidden-code
import UIKit
...
let uSurfAttrStr = NSMutableAttributedString(string: "BGG\n An Android app that generated board games based on entered number if players, difficulty, and time.")
...
let musicTweetAttrStr = NSMutableAttributedString(string: "Doot.\n     Don't mind the name, it's an iOS app that you can locate food trucks and pre-order on")
