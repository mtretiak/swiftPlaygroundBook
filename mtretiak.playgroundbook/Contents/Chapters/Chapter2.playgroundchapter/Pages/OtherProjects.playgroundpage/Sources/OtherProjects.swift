...
public class FeaturesView: UIView {
    ...
    override public init(frame: CGRect) {
        ...
        gradientLayer.colors = [#colorLiteral(red: 0.1098039216, green: 0.7098039216, blue: 0.8784313725, alpha: 1).cgColor, #colorLiteral(red: 0, green: 0, blue: 0.2745098039, alpha: 1).cgColor]
