...
/* Create pins */
public let canada = Annotation(at: CLLocationCoordinate2D(latitude: 60.239741, longitude: -112.397433),
                        title: "Canada", subtitle: "Home",
                        pin: "🇨🇦")

public let winnipeg = Annotation(at: CLLocationCoordinate2D(latitude: 49.898872, longitude: -97.167336),
                               title: "Winnipeg, Canada", subtitle: "Where I was born.",
                               pin: "👶🏼")
public let calgary = Annotation(at: CLLocationCoordinate2D(latitude: 51.050170, longitude: -114.080340),
                                 title: "Calgary, Canada", subtitle: "Currentl Location",
                                 pin: "👨🏼‍💻")

public let france = Annotation(at: CLLocationCoordinate2D(latitude: 46.570472, longitude: 2.930597),
                               title: "France", subtitle: nil,
                               pin: "🇫🇷")

public let hongkong = Annotation(at: CLLocationCoordinate2D(latitude: 22.336066, longitude: 114.173678),
                          title: "Hong Kong", subtitle: nil,
                          pin: "🇭🇰")

public let uk = Annotation(at: CLLocationCoordinate2D(latitude: 51.5073509, longitude: -0.1277583),
                    title: "United Kingdom", subtitle: nil, pin: "🇬🇧")

public let ireland = Annotation(at: CLLocationCoordinate2D(latitude: 53.273864, longitude: -9.049504),
                         title: "Ireland", subtitle: "Where I really learnt how to golf.",
                         pin: "🇮🇪")

public let germany = Annotation(at: CLLocationCoordinate2D(latitude: 48.370, longitude: 10.8978),
                         title: "Germany", subtitle: "Best trip of my life!",
                         pin: "🇩🇪")

public let china = Annotation(at: CLLocationCoordinate2D(latitude: 31.2304, longitude: 121.4737),
                       title: "China", subtitle: "Next place to visit.",
                       pin: "🇨🇳")
...
public let usa = Annotation(at: CLLocationCoordinate2D(latitude: 39.941960, longitude: -100.902899),
                                title: "Usa", subtitle: nil,
                                pin: "🇺🇸")
...
public let japan = Annotation(at: CLLocationCoordinate2D(latitude: 35.6895, longitude: 139.6917),
                       title: "Japan", subtitle: "Where you'll find me next winter.",
                       pin: "🇯🇵")

public let australia = Annotation(at: CLLocationCoordinate2D(latitude: -25.140030, longitude: 133.993089),
                              title: "Australia", subtitle: nil,
                              pin: "🇦🇺")

public let newZealand = Annotation(at: CLLocationCoordinate2D(latitude: -47.717242, longitude: 172.094642),
                                  title: "New Zealand", subtitle: nil,
                                  pin: "🇳🇿")

/// Intermediate middle point
public let center = CLLocationCoordinate2D(latitude: canada.coordinate.latitude, longitude: canada.coordinate.longitude)
